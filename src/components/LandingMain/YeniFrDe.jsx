  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const frDeBooks = productsObject['Fransız və Alman dilində kitablar'];
        setProducts(Array.isArray(frDeBooks) ? frDeBooks : []);
      } catch (error) {
        ...
        <div className="flex flex-row items-center justify-between w-full sm:w-[500px] h-auto">
          <div className="flex items-center gap-2 sm:gap-4 group-hover-trigger">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-[30px] text-[#000000] font-medium transition-colors duration-200">
              Yeni Fransız və Alman Nəşrləri
            </h2>
                    ...
                    >
                      ...
                      <div className="flex flex-grow flex-col justify-between p-2">
                        ...
                        <div className="mt-auto flex flex-col items-start gap-2 sm:gap-3">
                          ...
                          {currentQuantity > 0 ? (
                            <div className="flex h-auto w-full max-w-[140px] items-center justify-between gap-1 rounded-md z-60">
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                            ...
                            <button
                              className={`flex h-auto w-full max-w-[140px] cursor-pointer items-center justify-center gap-1 rounded-md px-1 py-1 text-white transition-colors duration-300 sm:gap-2 z-60 sm:px-1.5 sm:py-2 ${
