  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const englishBooks = productsObject['İngilis Dilində Kitablar'];
        if (Array.isArray(englishBooks)) {
          setProducts(englishBooks);
        } else {
          setProducts([]);
        }
      } catch (error) {
