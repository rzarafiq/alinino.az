...
const YeniAz = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const azerbaijanBooks = productsObject['Azərbaycan Dilində Kitablar'];
        if (Array.isArray(azerbaijanBooks)) {
          setProducts(azerbaijanBooks);
        } else {
          setProducts([]);
        }
      } catch (error) {
  ...
  return (
    <section className="section widget-slider py-4 mt-5">
